...
public class Order {
    ...
    public Order(@NotNull Long totalPay, @NotNull Long actualPay, @NotNull Integer paymentType, Integer postFee, String buyerMessage, String buyerNick,String receiver, String receiverMobile, String receiverState, String receiverCity, String receiverDistrict, String receiverAddress, String receiverZip, Integer invoiceType, Integer sourceType, List<OrderDetail> orderDetails) {
